...
public class VikingPeesImplementation implements IPeeable {

    @Override
    public void pee() {
        System.out.println(" A Viking is peeing, Il vichingo è fuori dalla coppa");
    }

    @Override
    public float likelihoodOfPeeing(int amountIngested) {
        Random rand = new Random();
        float randy = 1+ rand.nextInt(60); // randomInt es un numero entre 1 y 40 (Espartanos aguantan más)
